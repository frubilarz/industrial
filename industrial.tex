...
\insertimage[]{serviplott/organigrama}{width=13cm}{Organigrama Empresa.}
	...
	\item Conos de PVC.
	\insertimage[]{serviplott/mixproducto3}{width=10cm}{Cono PVC.}
	\end{itemize}
...
\section{Análisis de Proceso de almacenaje}
	...
	\insertimage[]{serviplott/almacenaje3}{width=12cm}{Normas de seguridad en la bodega}

	Esto queda más especificado en el siguiente esquema : 
	\insertimage[]{serviplott/almacenaje4}{width=14cm}{Esquema de seguridad.}
